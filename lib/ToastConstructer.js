...
class ToastConstructor extends Component {
  ...
  render () {
    const { position, custom, children, icon, toastStyle, textStyle, iconStyle, onPress, hideOnPress } = this.props;
    ...
    return visible && (<View style={[styles.container, offset]} pointerEvents={(onPress || hideOnPress) ? "box-none" : 'none'}>
